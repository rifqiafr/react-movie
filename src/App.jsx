...
function MainApp() { 
    ...
    return (
        <div className="app-container">
            {/* Header sudah menggunakan class CSS untuk Dark Theme */}
            <Header movieCount={movies.length} />

            <main className="main-content">
                <Routes>
                    {/* Halaman Home: Daftar Tontonan */}
                    <Route 
                        path="/" 
                        element={<Home 
                            movies={movies} 
                    ...
                    <Route 
                        ...
                        element={<AddPage 
                            ...
                            showToast={showToast} // PENTING: Meneruskan showToast ke AddPage
                        />} 
                    />
                    <Route 
                        path="/add/:id" 
...
function App() {
    return (
        <Router basename={import.meta.env.BASE_URL || '/react-movie/'}> 
            {/* Semua styling Dark Theme diterapkan via index.css */}
            <MainApp />
        </Router>
    );
}
